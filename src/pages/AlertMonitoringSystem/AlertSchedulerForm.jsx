        ...
        if (resetting) {
            ...
            Object.keys(formValue).forEach((key) => {
                if (["endAt", "startAt"].indexOf(key) != -1) {
                    ...
                    // console.warn("moment__",moment("27-06-2024 23:59:59"),moment("27-06-2024 23:59:59", "DD-MM-YYYY HH:mm:ss").toDate())
                    // console.warn("momentObj____", momentObj,momentObj.toDate())
                    // setValue(key, momentObj.toDate());

                    var date = moment(formValue[key], "DD-MM-YYYY HH:mm:ss");
                    var formattedDate = date.format("DD-MM-YY");
                    var htmlDateTime = moment(formattedDate, "DD-MM-YY").toISOString();
                    setValue(key, htmlDateTime);

                    console.info("formValue[key]___",formValue[key])
