...
const NokiaToolManagementQueryForm = ({ isOpen, setIsOpen, resetting, formValue = {} }) => {
    ...
    let Form = [
        {
            ...
            type: "select",
            option: [
                { "label": "PM KPI Check", "value": "PM KPI Check" },
                { "label": "RSI/PCI/PSC/BCCH", "value": "RSI/PCI/PSC/BCCH" },
                { "label": "TA Checks", "value": "TA Checks" },
                { "label": "Alarms Checks", "value": "Alarms Checks" },
                { "label": "CM Checks", "value": "CM Checks" }
            ],
            props: "",
            required: true,
            classes: "col-span-1"
    ...
    const onTableViewSubmit = (data) => {
        ...
        // dasdsadsadasdas
        if (data.id) {
            dispatch(nokiaPrePostActions.postData(true, data, () => {
...
export default NokiaToolManagementQueryForm;
