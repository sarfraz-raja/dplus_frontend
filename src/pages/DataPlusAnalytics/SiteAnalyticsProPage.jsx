                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-slate-900">Site Analytics Pro</h1>
                                    <p className="text-sm text-slate-500">Pre/post KPI comparison and PCI conflict analysis per site.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white border border-slate-200 rounded-3xl shadow-sm p-5">
                            <div className="grid grid-cols-1 xl:grid-cols-[320px_minmax(160px,1fr)_minmax(160px,1fr)_auto] gap-4 items-end">
