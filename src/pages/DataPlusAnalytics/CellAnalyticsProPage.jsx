    ...
    useEffect(() => {
        if (datew === 0) {
            if (urlUniqueId != null) {
                ...
                dispatch(nokiaPrePostActions.getcellnetworkanalyticspro(true, objectToQueryString({
        ...
        >
            ...
            <div className="flex items-center justify-between shrink-0">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-slate-800 leading-tight">Cell Analytics Pro</h1>
                        <p className="text-xs text-slate-400 font-medium tracking-wide">Pre/post KPI comparison and PCI conflict analysis per cell</p>
                    </div>
                </div>
                ...
                <div className="flex items-end gap-3">
                    <div className="flex flex-col">
                        <label className="text-[10px] text-slate-400 uppercase tracking-wide mb-1">Cell ID</label>
            ...
            <div className="flex-1 overflow-auto">
                {filteredSectionKeys.length === 0 ? (
                    <div className="text-center text-slate-400 text-sm py-16">
                        No data. Select a Cell ID and dates, then click Submit.
                    </div>
                ) : (
...
export default CellAnalyticsProPage;
