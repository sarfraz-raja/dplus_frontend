...
//   return (
//     <div className="h-full overflow-hidden bg-white px-6 py-6 dark:bg-gradient-to-br dark:from-[#0f1419] dark:to-[#1a1f2e]">
...
//               alt="DataPlus globe"
//               className="relative z-10 h-9 w-auto shrink-0 self-center drop-shadow-[0_0_10px_rgba(242,101,34,0.22)] sm:h-10"
//             />
...
//               <span className="font-['Quantico'] inline-flex w-max max-w-full min-w-0 items-baseline text-[20px] font-extrabold tracking-[0.08em] sm:text-[24px]">
//                 <span className="text-slate-900 dark:text-white">DATA</span>
//                 <span className="text-[#F26522]">PLUS</span>
//               </span>
//               <span className="mt-0.5 flex w-full min-w-0 items-end justify-end whitespace-nowrap text-[4px] font-medium leading-none tracking-[0.12em] text-slate-500 dark:text-white sm:text-[9px]">
...
//                   <p className="text-xs font-bold uppercase tracking-widest text-[#090728] dark:text-blue-600">Spatial Intelligence</p>
//                   <h2 className="mt-3 text-xl font-black text-slate-900 dark:text-white">GIS Engine</h2>
//                   <p className="mt-2 text-sm text-slate-500 dark:text-white">Visualize network layers on live maps - cells, sites, offices & drive tests with full spatial context.</p>
//                   <div className="mt-4 flex gap-3">
//                     <div className="rounded-lg bg-slate-50 px-3 py-2 border border-slate-200 dark:bg-white/5 dark:border-white/10 dark:backdrop-blur">
...
//                       <p className="text-xl font-black text-slate-900 dark:text-white">42.8K</p>
//                     </div>
//                   </div>
//                 </div>
//                 <button
//                   onClick={() => handleNavigation('/gis-engine')}
//                   className="relative mt-4 rounded-lg bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-6 transition-all flex items-center justify-center gap-2 self-start"
//                 >
...
//               <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-lg dark:border-slate-700 dark:bg-gradient-to-br dark:from-amber-900/30 dark:to-slate-900 dark:shadow-xl flex flex-col">
//                 <div className="absolute inset-0 opacity-10">
//                   <div className="absolute top-0 right-0 w-64 h-64 bg-orange-500 rounded-full blur-3xl"></div>
//                 </div>
//                 <div className="relative flex flex-col flex-1">
//                   <p className="text-xs font-bold uppercase tracking-widest text-[#090728] dark:text-blue-600">Analytics</p>
//                   <h3 className="mt-3 text-xl font-black text-slate-900 dark:text-white">Insights Engine</h3>
//                   <p className="mt-2 text-sm text-slate-500 dark:text-white flex-1">Drill into network KPIs with predictive analytics & degradation trends.</p>
//                   <button
//                     onClick={() => handleNavigation('/insights-engine/network-dashboard')}
//                     className="mt-4 rounded-lg bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-6 transition-all self-start"
//                   >
//                     Enter Engine
//                   </button>
//                 </div>
...
//                     <div>
//                       <p className="text-xs font-bold uppercase tracking-widest text-[#090728] dark:text-blue-600">Query</p>
...
//                   </div>
//                   <div className="rounded-lg bg-slate-900 p-3 overflow-hidden mb-3 dark:bg-black">
...
//                     </code>
//                   </div>
//                   <p className="text-xs text-slate-500 mb-3 dark:text-white flex-1">Execute complex SQL queries against real-time data sources</p>
//                   <button
//                     onClick={() => handleNavigation('/custom-query/workbench')}
//                     className="rounded-lg bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-6 transition-all self-start"
//                   >
//                     Open Workbench
//                   </button>
//                 </div>
...
//                   <p className="text-xs font-bold uppercase tracking-widest text-[#090728] dark:text-blue-600">Intelligence</p>
...
//               <div className="relative overflow-hidden rounded-3xl border border-blue-200 bg-white p-8 shadow-lg dark:border-blue-500/30 dark:bg-gradient-to-br dark:from-amber-900/30 dark:to-slate-900 dark:shadow-xl">
//                 <div className="absolute inset-0 opacity-10">
//                   <div className="absolute top-0 right-0 w-64 h-64 bg-orange-500 rounded-full blur-3xl"></div>
//                 </div>
//                 <div className="relative flex items-start justify-between">
//                   <div className="flex-1">
//                     <p className="text-xs font-bold uppercase tracking-widest text-[#090728] dark:text-blue-600">Collaboration</p>
