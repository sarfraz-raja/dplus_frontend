      ...
      <div className="mx-auto h-full max-w-[1600px] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto pr-2">
          <div className="space-y-6 pb-6">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 shadow-lg dark:border-orange-500/30 dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 dark:shadow-2xl">
              ...
              <div className="relative flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-2 max-w-md text-sm text-slate-500 dark:text-gray-400">Visualize network layers on live maps - cells, sites, offices & drive tests with full spatial context.</p>
                  <div className="mt-6 flex gap-4">
                    <div className="rounded-lg bg-slate-50 px-4 py-2 border border-slate-200 dark:bg-white/5 dark:border-white/10 dark:backdrop-blur">
                      <p className="text-xs text-slate-500 dark:text-gray-400">GIS LAYERS</p>
                      <p className="text-2xl font-black text-slate-900 dark:text-white">5</p>
                    </div>
                    <div className="rounded-lg bg-slate-50 px-4 py-2 border border-slate-200 dark:bg-white/5 dark:border-white/10 dark:backdrop-blur">
                      <p className="text-xs text-slate-500 dark:text-gray-400">ACTIVE NODES</p>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-gradient-to-br dark:from-slate-800 dark:to-slate-900 dark:shadow-xl">
                ...
                <p className="mt-2 text-sm text-slate-500 dark:text-gray-400">Drill into network KPIs with predictive analytics & degradation trends.</p>
                <button
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-gradient-to-br dark:from-slate-800 dark:to-slate-900 dark:shadow-xl">
                ...
                <p className="text-xs text-slate-500 mb-4 dark:text-gray-400">Execute complex SQL queries against real-time data sources</p>
                <button
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="rounded-3xl border border-amber-200 bg-white p-8 shadow-lg dark:border-yellow-600/30 dark:bg-gradient-to-br dark:from-amber-900/30 dark:to-slate-900 dark:shadow-xl">
                ...
                <p className="mt-2 text-sm text-slate-500 dark:text-gray-400">Threshold-based alerts on network KPIs with intelligent escalation.</p>
                <p className="mt-4 text-xs text-slate-500 dark:text-gray-400">Get notified when critical thresholds are breached</p>
                <button
              ...
              <div className="rounded-3xl border border-blue-200 bg-white p-8 shadow-lg dark:border-blue-500/30 dark:bg-gradient-to-br dark:from-slate-800 dark:to-slate-900 dark:shadow-xl">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mt-2 text-sm text-slate-500 dark:text-gray-400">Track, assign and escalate network tickets across teams with full audit trail and escalation management.</p>
                    <button
                  ...
                  <div className="ml-8 flex-shrink-0">
                    <div className="rounded-lg bg-slate-50 p-4 border border-slate-200 dark:bg-white/5 dark:backdrop-blur dark:border-white/10">
                      <p className="text-xs text-slate-500 mb-3 dark:text-gray-400">ACTIVE TICKETS</p>
