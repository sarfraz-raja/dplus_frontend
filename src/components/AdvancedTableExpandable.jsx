...
const AdvancedTableExpandable = ({ tableName = "", headerButton, filterAfter = () => { }, handleSubmit = () => { }, table, data, errors, register, setValue, getValues, totalCount = 10 }) => {
                    ...
                    data.length > 0 ?
                        <table border={1} className='w-[100%]  table-auto'>
                            <thead className='sticky -top-1 h-4 z-30'>
                                <tr>
                                    <th className=' border-primaryLine border-2 bg-primaryLine '>
