...
const CommonFormTwo = ({ classes,encType=false, Form, errors, handleSubmit, setValue, getValues, register }) => {
    ...
    let types = ["text", "password", "email", "hidden","number", "range"]
                    ...
                    return <>
                        ...
                        <div className={itm.classes ? itm.classes : "flex col-span-1 "}>
                            ...
                            {/* <div className={uiList[itm.type]["height"] + " col-span-4"}> */}
                                <div className={(uiList[itm.type]?.height || "h-[40px] w-[200px]") + " col-span-4"}>
                                 {
                                    types.indexOf(itm.type) != -1 ?
                                        <>
                                            <input 
                                                ...
                                                className={
                                                itm.type === "range"
                                                ? "w-full accent-orange-500 cursor-pointer"
                                                : "bg-white border-black border block h-8 w-full rounded-md py-1.5 p-2 text-white-900 shadow-sm ring-1 ring-inset ring-gray-300"
                                                }    
                                                {...itm.props}
                                            />
