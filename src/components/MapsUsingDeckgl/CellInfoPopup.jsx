...
const CellInfoPopup = ({
  ...
  return (
    <Dragger mapH={mapH} mapW={mapW} mapContainerHeight={mapContainerHeight}>
      <div
        style={{
          width: 280,
          background: "#ffffff",
      ...
      >
        {/* github.com/sarfraz-raja/dplus_frontend — header + tooltips + close */}
        <div
          data-drag-handle
          className="cursor-move select-none flex items-center justify-between px-3 py-2"
          style={{ background: ORANGE, borderRadius: "12px 12px 0 0" }}
        >
