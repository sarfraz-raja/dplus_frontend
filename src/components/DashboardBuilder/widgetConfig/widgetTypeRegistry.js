import {
  ...
  ScatterChart as ScatterChartIcon, Table, AlertTriangle, MapPin, Server,
} from 'lucide-react';
 ...
 */
export function chartLibraryStyleFieldsFor(chartType) {
  ...
  return [
    ...
    ...(CHART_TYPE_EXTRA_STYLE_FIELDS[chartType] || []),
  ];
}
